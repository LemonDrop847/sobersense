                ...
                <div className="container-fluid h-100 d-flex align-items-center justify-content-center">
                    <div className="row justify-content-center">
                        <div className="col-lg-8">
                            ...
                            <h1 className="display-1 my-3 fw-bold text-white">Your Shield Against Drunk Driving</h1>
             ...
             <div className="carousel-item text-center bg-cover vh-100 slide-2">
                <div className="container-fluid h-100 d-flex align-items-center justify-content-center">
                    <div className="row justify-content-center">
                        <div className="col-lg-8">
                            <h6 className="text-white">SoberSense.ai</h6>
                            <h1 className="display-1 my-3 fw-bold text-white">Innovating Roadway Vigilance</h1>
                            <a href="#" className="btn btn-brand">Get started</a>
                        </div>
                    </div>
                </div>
